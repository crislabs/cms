'use client'
import { usePetGetAdoption } from "@/src/hooks/adoptions";
...
interface Props {
 ...
 export function AdoptionDetails (props: Props) {
    ...
    const { data: adoption } = usePetGetAdoption(props.adoption)

    return (
      <React.Fragment >
      <HeadingDashboard title={adoption.data.name} adoption={adoption} />
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    ...
                    <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">{adoption.data.name}</h2>
